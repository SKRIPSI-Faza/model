...
set DART_FILE=%~dp0..\flutter_application_isyarat\lib\core\app_constants.dart
...
start "SnapSign Server" cmd /k "cd /d "%~dp0..\backend" && echo. && echo Server berjalan di http://%WIFI_IP%:8000 && echo Biarkan jendela ini TERBUKA. Ctrl+C untuk stop. && echo. && python server_v10.py --port 8000"
...
cd /d "%~dp0..\flutter_application_isyarat"
flutter run
